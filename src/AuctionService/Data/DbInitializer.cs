...
/// <summary>
/// Provides methods for initializing and seeding the database.
/// </summary>
public class DbInitializer
{
    /// <summary>
    /// Initializes a database by ensuring it is created and seeded with initial data 
    /// </summary>
    ...
    /// </summary>
    /// <param name="context"> The <see cref="AuctionDbContext"/> used to interact with database.</param>
    public static void SeedData(AuctionDbContext context)
    {
        ...
        var auctions = new List<Auction>()
        {
            ...
            new Auction
            {
                ...
                Status = Status.ReservePriceNotMet,
                ReservePrice = 50000,
                Seller = "tom",
                AuctionEnd = DateTime.UtcNow.AddDays(-10),
                Item = new Item
