  ...
  return (
    <form className='flex flex-col mt-3' onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className='grid grid-cols-2 gap-3'>
            ...
            <Input label='Mileage' name='mileage' control={control} rules={{required: "Color is required"}}/> 
        </div>
        {pathname === 'auctions/create' && 
        <>
            <Input label='Image URL' name='imageUrl' control={control} rules={{required: "Image URL is required is required"}}/>
            <div className='grid grid-cols-2 gap-3'>
